...
with tab_inf2:
    ...
    st.caption("Usa esta estructura detallada y numerada para diligenciar de manera rápida y segura tu declaración en el servicio informático electrónico de la DIAN, respetando el PDF original.")
    
    # Tabla estructurada con las casillas exactas del Formulario 210 (Mapeo desde el PDF)
    datos_f210 = [
        ...
        ["CÉDULA GENERAL", "42. Otras deducciones imputables (Trabajo)", f"${(ded_medicina + ded_gmf + ded_icetex + ded_dep_tradicional + ded_dep_adicional):,.0f}"],
        ...
        ["RENTA GRAVABLE", "98. Renta presuntiva (0 por ley actual)", f"$0"],
        ...
        ["LIQUIDACIÓN PRIVADA", "131. Saldo a favor año gravable anterior sin devolución", f"${saldo_favor_anterior:,.0f}"],
    ...
    df_f210 = pd.DataFrame(datos_f210, columns=["Sección DIAN", "Casilla / Concepto Formulario 210", "Valor Asignado (COP)"])
    st.table(df_f210)
